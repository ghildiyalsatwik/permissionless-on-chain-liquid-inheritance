...
#[derive(Accounts)]
pub struct ChangeInactivityTime<'info> {
    #[account(
        mut,
...
impl<'info> ChangeInactivityTime<'info> {

    pub fn change_inactivity_time(&mut self, inactivity_time: u64) -> Result<()> {
        ...
        self.inheritance.inactivity_time = inactivity_time;
